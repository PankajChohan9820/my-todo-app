...
import { Ballot, Check, FilterAlt, KeyboardArrowDown, QuestionMark} from "@mui/icons-material";
...
const TodoListFilter: FC<TodoListFilterProps> = ({filter, setFilter, todos})=>{
    ...
    return <>
        ...
        >
            {`${filterOptions.find(e=>e.key === filter)?.value} (${getCount(filter)})`}
        </Button>
        <Menu
